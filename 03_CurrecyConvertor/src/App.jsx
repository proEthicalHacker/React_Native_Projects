...
function App() {
  ...
  return (
    <div
      className="w-full h-screen flex flex-wrap justify-center item-center bg-no-repeat"
      style={{
      ...
      <div className="w-full">
        <div className=" w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30 ">
          <form
            ...
            <div className="w-full mb-1 rounded-md">
              <InputBox
                label="From"
                amount={amount}
            ...
            <button className="w-full bg-red-600 text-white px-4 py-3 rounded-lg">
